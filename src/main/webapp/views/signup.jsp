...
<div class="w-full max-w-md bg-white rounded-lg shadow-2xl p-8">
  <h2 class="text-3xl font-bold text-indigo-800 text-center mb-6">Create an Account</h2>
  ...
  <p class="mt-6 text-gray-600 text-center">
    ...
    <a href="login.jsp" class="text-indigo-600 hover:text-indigo-800 font-medium">Login here</a>
  </p>
</div>
</body>
</html>